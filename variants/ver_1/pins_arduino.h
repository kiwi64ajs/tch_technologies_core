...
const uint8_t PROGMEM digital_pin_to_port_PGM[] = {
	...
	PB	, // PB 7 ** 2 ** PWM2	I/O 1
	PB	, // PB 6 ** 3 ** PWM3	I/O 2
	PB	, // PB 5 ** 4 ** PWM4  I/O 3
	PB	, // PB 4 ** 5 ** PWM5	I/O 4
	PD	, // PD 0 ** 6 ** PWM6	I/O 5
	PD	, // PD 1 ** 7 ** PWM7	I/O 6
       	PD	, // PD 2 ** 8 ** D8    I/O 7
	PD	, // PD 3 ** 9 ** D9    1/O 8
	...
	PD	, // PD 7 ** 20 ** SDA  Factory Default Reset Pin
	PB	, // PD 0 ** 21 ** SCL
...
const uint8_t PROGMEM digital_pin_to_bit_mask_PGM[] = {
	...
	_BV( 7 )	, // PB 7 ** 2 ** PWM2 I/O 1   01/02
	_BV( 6 )	, // PB 6 ** 3 ** PWM3 I/O 2   03/04
	_BV( 5 )	, // PB 5 ** 4 ** PWM4 I/O 3   05/06
	_BV( 4 )	, // PB 4 ** 5 ** PWM5 I/O 4   07/08
	_BV( 0 )	, // PD 0 ** 6 ** PWM6 I/O 5   09/0A
	_BV( 1 )	, // PD 1 ** 7 ** PWM7 I/O 6   0B/0C
	_BV( 2 )	, // PD 2 ** 8 ** D8   I/O 7   0D/0E
	_BV( 3 )	, // PD 6 ** 9 ** D9   I/O 8   0F/10
	...
	_BV( 7 )	, // PD 1 ** 20 ** SDA  Factory Default Reset Pin
	_BV( 0 )	, // PD 0 ** 21 ** SCL
	...
	_BV( 5 )	, // PE 5 ** 30 ** I/O 25   31/32
	_BV( 4 )	, // PE 4 ** 31 ** I/O 26   33/34
	_BV( 3 )	, // PE 3 ** 32 ** I/O 27   35/36
	_BV( 2 )	, // PE 2 ** 33 ** I/O 28   37/38
