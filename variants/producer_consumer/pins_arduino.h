...
const uint8_t PROGMEM digital_pin_to_bit_mask_PGM[] = {
	...
	_BV( 3 )	, // PB 3 ** 20 ** SDA  Factory Default Reset Pin
	_BV( 4 )	, // PD 0 ** 21 ** SCL
	...
	_BV( 2 )	, // PB 2 ** 30 ** I/O 25   31/32
	_BV( 0 )	, // PB 0 ** 31 ** I/O 26   33/34
	_BV( 7 )	, // PE 7 ** 32 ** I/O 27   35/36
	_BV( 6 )	, // PE 6 ** 33 ** I/O 28   37/38
	_BV( 5 )	, // PE 5 ** 34 ** I/O 29   39/3A
	_BV( 4 )	, // PE 4 ** 35 ** I/O 30   3B/3C
